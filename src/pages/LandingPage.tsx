      ...
      <section id="faq" className="lp-section lp-faq-bg">
        <div className="lp-container">
          ...
          <div className="lp-faq-list">
            {[
              {q:"Нужны ли навыки программирования?",a:"Нет. Весь конструктор визуальный — добавляй блоки кнопкой «+ Добавить блок», перетаскивай их мышкой, соединяй стрелками. Никакого кода."},
              {q:"Как создать первого бота?",a:"Зайди в «Мои боты» → «+ Создать бота» → открой конструктор. На схеме уже есть стартовый узел «Триггер» с приветственным сообщением. Измени текст, нажми «Применить» и «Сохранить» — базовый бот готов."},
              {q:"Как работает ветвление по ответам пользователя?",a:"Добавь узел «Условие» и в его названии укажи ключевые слова через запятую (например: да,хочу,конечно). Соедини узел стрелкой из предыдущего блока. Из условий автоматически формируются кнопки быстрых ответов в чате."},
